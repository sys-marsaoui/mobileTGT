...
public class DetailsEventsForm extends Form{
     ...
     EventsService eventsService = new EventsService();
        public DetailsEventsForm(Events e){
            ...
            Label lAdresseEvents = new Label("Adresse: " + e.getThemeEvents());
            ...
            cDetaille.addAll(lTitreEvents,lDescriptionEvents,lAdresseEvents,lDateEvents,lThemeEvents,lprixEvents,cb);
            this.add(cDetaille);
