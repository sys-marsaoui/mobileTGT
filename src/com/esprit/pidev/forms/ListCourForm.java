...
public class ListCourForm extends Form {
    ...
    public void afficher(Formation f) {

        for (Cour c : CoursService.getMesCoursFormation(f.getFormation_id())) {
    ...
    public ListCourForm(Formation formtion) {

        afficher(formtion);
        //System.out.println(formtion);
        //formation = formtion;
