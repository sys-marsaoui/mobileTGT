...
public class Cour {
    ...
    public Cour(int cour_id, int formation_id, String titre_cour, String description_cour, int duree_cour, String text_cour, String image,int note) {
    ...
    public Cour(int formation_id, String titre_cour, String description_cour, int duree_cour, String text_cour, String image,int note) {
        this.formation_id = formation_id;
        this.titre_cour = titre_cour;
        this.description_cour = description_cour;
        this.duree_cour = duree_cour;
