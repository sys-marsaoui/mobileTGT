...
private Integer dureeContrat;
    ...
    public Contrat(int id, Casting id_casting, Candidat idcandidat, Float salaire, String typeContrat, Integer dureeContrat) {
        this.id = id;
    ...
    public Contrat(Casting id_casting, Candidat idcandidat, Float salaire, String typeContrat, Integer dureeContrat) {
        this.id_casting = id_casting;
        this.idcandidat = idcandidat;
        this.salaire = salaire;
        this.typeContrat = typeContrat;
