...
public class Organisations {
     ...
     private Integer tel_organisation;
    ...
    public Organisations(String NomOrganisation, String Apropos, String AdresseOrganisation, Integer tel_organisation, String Email_Org, String LoginOrganisation, String PasswordOrganisation) {
        this.NomOrganisation = NomOrganisation;
    ...
    public Organisations(int id, String NomOrganisation, String Apropos, String AdresseOrganisation, Integer tel_organisation, String Email_Org, String LoginOrganisation, String PasswordOrganisation) {
        this.id = id;
        this.NomOrganisation = NomOrganisation;
        this.Apropos = Apropos;
        this.AdresseOrganisation = AdresseOrganisation;
    ...
    public Organisations(String NomOrganisation, String Apropos, String AdresseOrganisation, Integer tel_organisation, String Email_Org) {
        this.NomOrganisation = NomOrganisation;
        this.Apropos = Apropos;
        this.AdresseOrganisation = AdresseOrganisation;
        this.tel_organisation = tel_organisation;
    ...
    public Organisations(int id, String NomOrganisation, String Apropos, String AdresseOrganisation, Integer tel_organisation, String Email_Org) {
        this.id = id;
        this.NomOrganisation = NomOrganisation;
        this.Apropos = Apropos;
        this.AdresseOrganisation = AdresseOrganisation;
    ...
    public Integer getTel_organisation() {
        return tel_organisation;
    }

    public void setTel_organisation(Integer tel_organisation) {
        this.tel_organisation = tel_organisation;
    }
